...
import type { EndpointsInputConfig, EndpointsResolvedConfig } from "@smithy/core/dist-types/submodules/config/config-resolver/endpointsConfig/resolveEndpointsConfig";
/**
 * @public
