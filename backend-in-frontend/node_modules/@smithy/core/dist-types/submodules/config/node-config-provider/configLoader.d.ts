...
import { type EnvOptions, type GetterFromEnv } from "@smithy/core/dist-types/submodules/config/node-config-provider/fromEnv";
import { type GetterFromConfig, type NodeSharedConfigInit } from "@smithy/core/dist-types/submodules/config/node-config-provider/fromSharedConfigFiles";
import { type FromStaticConfig } from "@smithy/core/dist-types/submodules/config/node-config-provider/fromStatic";
/**
 * @internal
 */
