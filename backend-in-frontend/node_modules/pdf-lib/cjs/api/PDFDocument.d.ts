import PDFEmbeddedPage from "pdf-lib/src/api/PDFEmbeddedPage";
import PDFFont from "pdf-lib/src/api/PDFFont";
import PDFImage from "pdf-lib/src/api/PDFImage";
import PDFPage from "pdf-lib/src/api/PDFPage";
import PDFForm from "pdf-lib/src/api/form/PDFForm";
import { StandardFonts } from "pdf-lib/src/api/StandardFonts";
import { PageBoundingBox, PDFCatalog, PDFContext } from "pdf-lib/src/core";
import { AttachmentOptions, SaveOptions, Base64SaveOptions, LoadOptions, CreateOptions, EmbedFontOptions, SetTitleOptions } from "pdf-lib/src/api/PDFDocumentOptions";
import PDFRef from "pdf-lib/src/core/objects/PDFRef";
import { Fontkit } from "pdf-lib/src/types/fontkit";
import { TransformationMatrix } from "pdf-lib/src/types/matrix";
/**
