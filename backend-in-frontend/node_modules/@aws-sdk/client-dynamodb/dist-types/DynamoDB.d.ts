...
import { type BatchExecuteStatementCommandInput, type BatchExecuteStatementCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/BatchExecuteStatementCommand";
import { type BatchGetItemCommandInput, type BatchGetItemCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/BatchGetItemCommand";
import { type BatchWriteItemCommandInput, type BatchWriteItemCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/BatchWriteItemCommand";
import { type CreateBackupCommandInput, type CreateBackupCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/CreateBackupCommand";
import { type CreateGlobalTableCommandInput, type CreateGlobalTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/CreateGlobalTableCommand";
import { type CreateTableCommandInput, type CreateTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/CreateTableCommand";
import { type DeleteBackupCommandInput, type DeleteBackupCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DeleteBackupCommand";
import { type DeleteItemCommandInput, type DeleteItemCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DeleteItemCommand";
import { type DeleteResourcePolicyCommandInput, type DeleteResourcePolicyCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DeleteResourcePolicyCommand";
import { type DeleteTableCommandInput, type DeleteTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DeleteTableCommand";
import { type DescribeBackupCommandInput, type DescribeBackupCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeBackupCommand";
import { type DescribeContinuousBackupsCommandInput, type DescribeContinuousBackupsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeContinuousBackupsCommand";
import { type DescribeContributorInsightsCommandInput, type DescribeContributorInsightsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeContributorInsightsCommand";
import { type DescribeEndpointsCommandInput, type DescribeEndpointsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeEndpointsCommand";
import { type DescribeExportCommandInput, type DescribeExportCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeExportCommand";
import { type DescribeGlobalTableCommandInput, type DescribeGlobalTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeGlobalTableCommand";
import { type DescribeGlobalTableSettingsCommandInput, type DescribeGlobalTableSettingsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeGlobalTableSettingsCommand";
import { type DescribeImportCommandInput, type DescribeImportCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeImportCommand";
import { type DescribeKinesisStreamingDestinationCommandInput, type DescribeKinesisStreamingDestinationCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeKinesisStreamingDestinationCommand";
import { type DescribeLimitsCommandInput, type DescribeLimitsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeLimitsCommand";
import { type DescribeTableCommandInput, type DescribeTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeTableCommand";
import { type DescribeTableReplicaAutoScalingCommandInput, type DescribeTableReplicaAutoScalingCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeTableReplicaAutoScalingCommand";
import { type DescribeTimeToLiveCommandInput, type DescribeTimeToLiveCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DescribeTimeToLiveCommand";
import { type DisableKinesisStreamingDestinationCommandInput, type DisableKinesisStreamingDestinationCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/DisableKinesisStreamingDestinationCommand";
import { type EnableKinesisStreamingDestinationCommandInput, type EnableKinesisStreamingDestinationCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/EnableKinesisStreamingDestinationCommand";
import { type ExecuteStatementCommandInput, type ExecuteStatementCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ExecuteStatementCommand";
import { type ExecuteTransactionCommandInput, type ExecuteTransactionCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ExecuteTransactionCommand";
import { type ExportTableToPointInTimeCommandInput, type ExportTableToPointInTimeCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ExportTableToPointInTimeCommand";
import { type GetItemCommandInput, type GetItemCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/GetItemCommand";
import { type GetResourcePolicyCommandInput, type GetResourcePolicyCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/GetResourcePolicyCommand";
import { type ImportTableCommandInput, type ImportTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ImportTableCommand";
import { type ListBackupsCommandInput, type ListBackupsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListBackupsCommand";
import { type ListContributorInsightsCommandInput, type ListContributorInsightsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListContributorInsightsCommand";
import { type ListExportsCommandInput, type ListExportsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListExportsCommand";
import { type ListGlobalTablesCommandInput, type ListGlobalTablesCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListGlobalTablesCommand";
import { type ListImportsCommandInput, type ListImportsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListImportsCommand";
import { type ListTablesCommandInput, type ListTablesCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListTablesCommand";
import { type ListTagsOfResourceCommandInput, type ListTagsOfResourceCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ListTagsOfResourceCommand";
import { type PutItemCommandInput, type PutItemCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/PutItemCommand";
import { type PutResourcePolicyCommandInput, type PutResourcePolicyCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/PutResourcePolicyCommand";
import { type QueryCommandInput, type QueryCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/QueryCommand";
import { type RestoreTableFromBackupCommandInput, type RestoreTableFromBackupCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/RestoreTableFromBackupCommand";
import { type RestoreTableToPointInTimeCommandInput, type RestoreTableToPointInTimeCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/RestoreTableToPointInTimeCommand";
import { type ScanCommandInput, type ScanCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/ScanCommand";
import { type TagResourceCommandInput, type TagResourceCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/TagResourceCommand";
import { type TransactGetItemsCommandInput, type TransactGetItemsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/TransactGetItemsCommand";
import { type TransactWriteItemsCommandInput, type TransactWriteItemsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/TransactWriteItemsCommand";
import { type UntagResourceCommandInput, type UntagResourceCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UntagResourceCommand";
import { type UpdateContinuousBackupsCommandInput, type UpdateContinuousBackupsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateContinuousBackupsCommand";
import { type UpdateContributorInsightsCommandInput, type UpdateContributorInsightsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateContributorInsightsCommand";
import { type UpdateGlobalTableCommandInput, type UpdateGlobalTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateGlobalTableCommand";
import { type UpdateGlobalTableSettingsCommandInput, type UpdateGlobalTableSettingsCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateGlobalTableSettingsCommand";
import { type UpdateItemCommandInput, type UpdateItemCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateItemCommand";
import { type UpdateKinesisStreamingDestinationCommandInput, type UpdateKinesisStreamingDestinationCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateKinesisStreamingDestinationCommand";
import { type UpdateTableCommandInput, type UpdateTableCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateTableCommand";
import { type UpdateTableReplicaAutoScalingCommandInput, type UpdateTableReplicaAutoScalingCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateTableReplicaAutoScalingCommand";
import { type UpdateTimeToLiveCommandInput, type UpdateTimeToLiveCommandOutput } from "@aws-sdk/client-dynamodb/dist-types/commands/UpdateTimeToLiveCommand";
import { DynamoDBClient } from "@aws-sdk/client-dynamodb/dist-types/DynamoDBClient";
import type { ResourceNotFoundException } from "@aws-sdk/client-dynamodb/dist-types/models/errors";
