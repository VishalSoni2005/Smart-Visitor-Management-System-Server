...
import type { BatchExecuteStatementCommandInput, BatchExecuteStatementCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/BatchExecuteStatementCommand";
import type { BatchGetCommandInput, BatchGetCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/BatchGetCommand";
import type { BatchWriteCommandInput, BatchWriteCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/BatchWriteCommand";
import type { DeleteCommandInput, DeleteCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/DeleteCommand";
import type { ExecuteStatementCommandInput, ExecuteStatementCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/ExecuteStatementCommand";
import type { ExecuteTransactionCommandInput, ExecuteTransactionCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/ExecuteTransactionCommand";
import type { GetCommandInput, GetCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/GetCommand";
import type { PutCommandInput, PutCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/PutCommand";
import type { QueryCommandInput, QueryCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/QueryCommand";
import type { ScanCommandInput, ScanCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/ScanCommand";
import type { TransactGetCommandInput, TransactGetCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/TransactGetCommand";
import type { TransactWriteCommandInput, TransactWriteCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/TransactWriteCommand";
import type { UpdateCommandInput, UpdateCommandOutput } from "@aws-sdk/lib-dynamodb/dist-types/commands/UpdateCommand";
